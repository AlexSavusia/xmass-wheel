...
<script>
    ...
    let coupon
    let user =  <?php if(!empty($user)): ?> <?php echo json_encode($user); ?> <?php else: ?> false  <?php endif; ?>;
    let spinInfo =  <?php if(!empty($spin_info)): ?> <?php echo json_encode($spin_info); ?> <?php else: ?> false  <?php endif; ?>;
    let freeAttempt =  <?php if(!empty($free_attempt_available_time_at)): ?> <?php echo json_encode($free_attempt_available_time_at); ?> <?php else: ?> false  <?php endif; ?>;
    let token =  <?php if(!empty($token)): ?> <?php echo json_encode($token); ?> <?php else: ?> false  <?php endif; ?>;
    let prizes
...
<?php /**PATH C:\xampp\htdocs\laravel\xmas2022\resources\views/spin.blade.php ENDPATH**/ ?>